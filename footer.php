				...
				<div class="row">
			        ...
			        <div class="col-sm-4 text-right text-center-xs">
			        	<ul class="social-list list-inline">
	                        <li>
	                            <a href="https://www.instagram.com/kleinscharig/" target="_blank" title="instagram">
	                                <i class="socicon socicon-instagram icon icon--xs"></i>
	                            </a>
	                        </li>
	                        <li>
	                            <a href="https://www.facebook.com/kleinscharig.amersfoort/" target="_blank" title="facebook">
	                                <i class="socicon socicon-facebook icon icon--xs"></i>
	                            </a>
	                        </li>
	                        <li>
	                            <a href="https://m.me/kleinscharig.amersfoort" title="messenger">
	                                <i class="socicon socicon-messenger icon icon--xs"></i>
								</a>
							</li>
	                        <li>
	                            <a href="https://www.pinterest.com/kleinscharig" target="_blank" title="pinterest">
	                                <i class="socicon socicon-pinterest icon icon--xs"></i>
	                            </a>
	                        </li>
	                        <li>
	                            <a itemprop="email" href="mailto:info@kleinscharig.nl" title="email">
