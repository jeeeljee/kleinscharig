    ...
    <section class=\"loginSection row\">
        ...
        if (((array_key_exists("isValidHost", $context) && array_key_exists("invalidHostMessage", $context)) && (($context["isValidHost"] ?? $this->getContext($context, "isValidHost")) == false))) {
            ...
            echo "            <div class=\"contentForm loginForm\">
                ";
            // line 57
            $this->loadTemplate("@Login/login.twig", "@Login/login.twig", 57, "597295810")->display(array_merge($context, array("title" => call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Login_LogIn")))));
            // line 123
            echo "            </div>
            <div class=\"contentForm resetForm\" style=\"display:none;\">
                ";
            // line 125
            $this->loadTemplate("@Login/login.twig", "@Login/login.twig", 125, "2128290961")->display(array_merge($context, array("title" => call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Login_ChangeYourPassword")))));
            // line 180
            echo "            </div>
        ";
        }
...
{% endblock %}
", "@Login/login.twig", "/www/analytics/plugins/Login/templates/login.twig");
    }
}


/* @Login/login.twig */
class __TwigTemplate_1d2e1574e9d3f539b0abd9f02e3a4aed1e5ee8e9b922afd8b9a68fb774d7d868_597295810 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);
...
/* @Login/login.twig */
class __TwigTemplate_1d2e1574e9d3f539b0abd9f02e3a4aed1e5ee8e9b922afd8b9a68fb774d7d868_2128290961 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);
