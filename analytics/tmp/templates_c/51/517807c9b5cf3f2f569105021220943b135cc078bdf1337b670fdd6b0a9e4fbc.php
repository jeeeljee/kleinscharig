...
class __TwigTemplate_a30ed3e190a1921ba14c8f4ad33ce6a6d1522c7d7e78d43d0176619deda3789b extends Twig_Template
{
    ...
    <div class=\"contentHelp\">
        ";
        // line 9
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Goals_LearnMoreAboutGoalTrackingDocumentation", "<a href='?module=Proxy&action=redirect&url=https://matomo.org/docs/tracking-goals-web-analytics/' target='_blank'>", "</a>"));
        echo "
        ...
        if ( !($context["ecommerceEnabled"] ?? $this->getContext($context, "ecommerceEnabled"))) {
            ...
            ob_start();
            // line 17
            echo "                <a href=\"https://matomo.org/docs/ecommerce-analytics/\" rel=\"noreferrer\" target=\"_blank\">";
        ...
        if (twig_test_empty(($context["goals"] ?? $this->getContext($context, "goals")))) {
            ...
            echo "            <tr>
                <td colspan='8'>
                    ...
                    ";
            // line 42
            echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), array(call_user_func_array($this->env->getFilter('translate')->getCallable(), array("Goals_ThereIsNoGoalToManage", ($context["siteName"] ?? $this->getContext($context, "siteName"))))));
            echo ".
                    <br/><br/>
                </td>
            </tr>
...
", "@Goals/_listGoalEdit.twig", "/www/analytics/plugins/Goals/templates/_listGoalEdit.twig");
    }
}
