...
class __TwigTemplate_a73548a0c01d368ba3ae3234babd3eaa7cac38278ea1c2beb83884bd6a33c22d extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 3
        echo "    ";
        echo call_user_func_array($this->env->getFilter('translate')->getCallable(), array("CoreUpdater_HelpMessageContent", "<a target=\"_blank\" href=\"?module=Proxy&action=redirect&url=https://matomo.org/faq/\">", "</a>", "</li><li>"));
        echo "
";
...
";
    ...
    <div class=\"content\">
        ...
        <ul>
            ...
            echo " <a href='https://matomo.org/faq/how-to-update/#faq_179' rel='noreferrer' target='_blank'>(see FAQ)</a></li>
            <li>";
            // line 28
...
";
    ...
    <div class=\"content\">
        ...
        ";
            ...
            ";
                // line 58
                if ((array_key_exists("deactivatedPlugins", $context) && (twig_length_filter($this->env, ($context["deactivatedPlugins"] ?? $this->getContext($context, "deactivatedPlugins"))) > 0))) {
                    // line 59
                    echo "                ";
                    ...
                    ";
                    // line 61
                    echo \Piwik\piwik_escape_filter($this->env, call_user_func_array($this->env->getFilter('translate')->getCallable(), array("CoreUpdater_WeAutomaticallyDeactivatedTheFollowingPlugins", ($context["listOfDeactivatedPlugins"] ?? $this->getContext($context, "listOfDeactivatedPlugins")))), "html", null, true);
                    echo "
                </div>
            ";
                }
...
{% endblock %}
", "@CoreUpdater/runUpdaterAndExit_done.twig", "/www/analytics/plugins/CoreUpdater/templates/runUpdaterAndExit_done.twig");
    }
}
